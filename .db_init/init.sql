...
CREATE TABLE IF NOT EXISTS projects (
    ...
    view_case_href VARCHAR(255),
    -- For "View Case" type links
...
CREATE TABLE IF NOT EXISTS project_images(
    ...
    -- Cloudianary public ID for this image
    description TEXT,
...
VALUES (
        ...
        '/assets/portfolioImages/warmini/minis-list.png',
        -- Placeholder: Update if served from app/blob
        '/assets/portfolioImages/warmini/WSLogo.jpeg',
        -- Placeholder: Update if served from app/blob
        'https://github.com/YOUR_USERNAME/YOUR_WARMINI_REPO',
        -- <<< PLEASE UPDATE THIS
        'https://your-warmini-demo-live-url.com',
        -- <<< PLEASE UPDATE THIS
        '#F7BF00'
    ) ON CONFLICT (slug) DO NOTHING;
-- Prevents error if script runs again on existing data
INSERT INTO projects (
        title,
        slug,
        description,
...
VALUES (
        ...
        '/assets/portfolioImages/erp/erpHome.png',
        -- Placeholder: Update if served from app/blob
        '/assets/portfolioImages/erp/stgLogo.png',
        -- Placeholder: Update if served from app/blob
        'https://your-stg-erp-case-study-url.com',
        -- <<< PLEASE UPDATE THIS (or use live_demo_url field instead)
        '#F7BF00'
    ) ON CONFLICT (slug) DO NOTHING;
...
VALUES (
        ...
        'minis-list_x0pcqh',
        'Home view',
        'WarMiniPricer home screenshot',
        0
    ),
    (
        1,
        'mini-detail_maj080',
        'Miniature detail view',
        'Screenshot of war mini details',
        1
    ),
    (
        1,
        'portfolio/warminipricer/mobile_view_01',
        'Mobile interface',
        'WarMiniPricer on a mobile device',
        2
    ),
    (
        1,
        'modalStoreOrder_j3q9gg',
        'Store Order Modal',
        'Store order form',
        3
    ),
...
VALUES (
        2,
        'projectDashboard_ci8o48',
        'STG-ERP Dashboard',
        'STG-ERP dashboard overview',
        0
    ),
    (
        2,
        'projectDetail_i5t2ov',
        'STG-ERP Project Detail',
